        ...
        <div id="layoutSidenav_content">
            <div class="container px-3">
                ...
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li id="page-actuel" class="breadcrumb-item"><a href="/ab/views/justifier/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>">< Page-Precédent</a></li>
                        <li id="page-precedent" class="breadcrumb-item"><a href="/ab/views/justifier/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>">Retour</a></li>
                ...
                <div class="data-table">
                    <?php                       
                        ...
                        {
                    ?>
                    <span class="btn btn-outline-warning text-black fs-5 mb-2 mt-3 disabled w-100">liste de la classe</span>
                    <div id="table-container" class="mt-3" >
                     ...
                     <tbody>
                        ...
                        <!-- *mettre tout ligne en blanc si la presence est null -->
                                    ...
                                    <td>
                                        <a class="btn fw-bold p-2 text-black bg-light btn-outline-warning"
                                        href="/ab/views/nombre_absence/absence.php?id=<?= $ligne["id"] ?>&niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>">Voir</a>
                                     </td>
                            </tr>
                         <?php  }  ?>
                     </tbody>

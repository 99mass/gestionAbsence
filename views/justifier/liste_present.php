...
<body class="sb-nav-fixed">
            ...
            <div class="container px-2">
                ...
                <div class="alert alert-dark  mt-2 mb-3 " role="alert">
                 ...
                 <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li id="page-actuel" class="breadcrumb-item"><a href="../../views/justifier/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>">< Page-Precédent</a></li>
                        <li id="page-precedent" class="breadcrumb-item"><a href="../../views/justifier/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>">Retour</a></li>
   ...
   <div class="data-table">
         <div class="w-100" >
                  ...
                  <a href="/ab/views/justifier/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" id="btn-liste-present" class="text-decoration-none btn btn-outline-danger">
                        <i class="fa-solid fa-link me-1 fs-5"></i>liste absence 
                  </a> 
         </div>
        <span class="btn btn-outline-success text-capitalize text-success fs-5 text-center disabled fs-5 mt-4  mb-2 fw-bold w-100">
                    liste eléve présent
         </span>
                <form action="/ab/views/justifier/liste_present.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" method="POST" class="mb-2" >
             ...
             <?php 
             require_once('../../models/voir_presenceModel/liste_present.php');
                $numeroLigne=1;
                ...
                <div id="table-container">
                    <table id="datatablesSimple" class="display pt-3 mt-3">
                        ...
                        <tbody>
                         ...
                         <?php  // Mois actuel
                                if(count($liste_present) > 0)
                                {  
                            ?>
                                   
                                    <?php  foreach($liste_present as $ligne){   ?>
                                             <tr >                                                                

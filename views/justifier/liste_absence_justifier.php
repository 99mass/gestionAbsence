...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div class="data-table">
         <div class="w-100" >
                  <a href="/ab/views/justifier/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" id="btn-absence-justifier" class="btn btn-outline-danger text-decoration-none">
            ...
            <span class="btn btn-outline-primary text-capitalize text-primary text-center disabled fs-5 mt-4  mb-2 fw-bold w-100">
                ...
                <form action="/ab/views/justifier/liste_absence_justifier.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" method="POST" class="mb-2" >

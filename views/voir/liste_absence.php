        ...
        <div class="data-table">
         ...
         <div class="w-100 mb-4" >
                  ...
                  <a href="/ab/views/voir/liste_present.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" id="btn-liste-present" class="text-decoration-none btn btn-outline-success">
                        <i class="fa-solid fa-link me-1 fs-5"></i>Présent 
                  </a> 
        </div>
                ...
                <form action="/ab/views/voir/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" method="POST" class="mb-2" >

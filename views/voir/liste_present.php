...
<body class="sb-nav-fixed">
   ...
   <div class="data-table">
         ...
         <div class="w-100" >
                  ...
                  <a href="../../views/voir/liste_absence.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" id="btn-liste-present" class="text-decoration-none btn btn-outline-danger">
        ...
        <span class="btn btn-outline-success text-capitalize text-success fs-5 text-center disabled fs-5 mt-4  mb-2 fw-bold w-100">
                ...
                <form action="/ab/views/voir/liste_present.php?niveau=<?=$_GET['niveau'] ?>&serie=<?= $_GET['serie']?>&classe=<?= $_GET['classe']?>" method="POST" class="mb-2" >
                ...
                <div id="table-container">
                    <table id="datatablesSimple" class="display pt-3 mt-3" >
                        ...
                        <tbody>
                         ...
                         <?php  //si les données recuperés n'est pas vide
